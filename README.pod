...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Mac-OSVersion> or 
L<MetaCPAN|http://www.metacpan.org/module/Mac::OSVersion>:

=over 4

=item *	L<http://search.cpan.org/dist/Mac-OSVersion>

=item *	L<http://www.metacpan.org/module/Mac::OSVersion>
